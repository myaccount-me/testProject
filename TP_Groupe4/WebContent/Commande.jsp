...
<form method="get" action="CommandeServlet">
<fieldset>
...
<input type="text" id="montant" name="montant" value="${param.montant}" size="20" maxlength="20" /><span style="font-size:11px;color:red;">${erreurs["montant"]}</span><br /> 
<label for="modePaiementCommande">Mode de paiement <span
class="requis">*</span></label> <input type="text" id="modeP" name="modeP" value="${param.modeP}" size="20" maxlength="20" /> <span style="font-size:11px;color:red;">${erreurs["modeP"]}</span><br /> 
 <label for="statutPaiementCommande">Statut du paiement</label> 
 <input type="text" id="statutP" name="statutP" value="${param.statutP}" size="20" maxlength="20" /><br />
  <label for="modeLivraisonCommande">Mode de livraison <span class="requis">*</span>
</label> <input type="text" id="modeL" name="modeL" value="${param.modeL}" size="20" maxlength="20" /><span style="font-size:11px;color:red;">${erreurs["modeL"]}</span><br /> 
 <label for="statutLivraisonCommande">Statut de la livraison</label>
 <input type="text" id="statutL" name="statutL" value="${param.statutL}" size="20" maxlength="20" /> <br />
</fieldset>
